...
export default function WhatsAppButton() {
  ...
  return (
    <button
      onClick={handleClick}
      className="fixed bottom-4 right-4 z-50 bg-[#25D366] hover:bg-[#20BA5C] text-white rounded-full p-3 shadow-lg transition-all duration-300 hover:scale-110 group"
